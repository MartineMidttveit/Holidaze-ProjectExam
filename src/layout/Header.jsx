...
export default function Header() {
    return (
        <header className="font-poppins text-primary">
            <div className="grid grid-cols-3 justify-between items-center bg-background h-20 px-[5%] lg:px-[7%] 2xl:px-[10%] shadow-lg z-10 relative">
                ...
                <nav className="flex gap-4 items-center justify-end">
                    <div className="flex mr-12">
                        ...
                        <Link to="/venues" className="px-8">Venues</Link>
                    </div>
