export default function Terms() {
    return (
        <div className="leading-relaxed pt-6 lg:pt-10 2xl:pt-12">
            <div className="px-[5%] lg:px-[7%] 2xl:px-[36%] pb-6 lg:pb-8">
                <p className="text-contrast font-bold tracking-widest text-sm md:text-base">LEGAL</p>
                <h1 className="text-2xl font-bold pt-1">Terms & Conditions</h1>
                ...
                <h2 className="font-semibold">Booking and Payment</h2>
                ...
                <h2 className="font-semibold">Host Responsibilities</h2>
                <ul className="list-disc pl-5 font-normal py-4 flex flex-col gap-2 pt-2">
                ...
                <h2 className="font-semibold">Cancellation and Refund Policy</h2>
                <ul className="list-disc pl-5 font-normal py-4 flex flex-col gap-2 pt-2">
            ...
            <div className="bg-background">
                <div className="px-[5%] lg:px-[7%] 2xl:px-[36%] py-6 lg:py-10 2xl:py-12">
                    <h2 className="text-2xl font-bold pb-2">Cookie Policy</h2>
                    <ul className="list-disc pl-5 font-normal py-4 flex flex-col gap-2 pt-2">
            ...
            <div className="bg-customLightBlue py-6 lg:py-10 2xl:py-12">
                <div className="px-[5%] lg:px-[7%] 2xl:px-[36%]">
                    <h2 className="text-2xl font-bold pb-2">Privacy Policy</h2>
                    <ul className="list-disc pl-5 font-normal py-4 flex flex-col gap-2 pt-2">
